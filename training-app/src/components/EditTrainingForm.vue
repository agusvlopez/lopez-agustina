            ...
            <form action="#" @submit.prevent="edit">
                <div class="flex flex-wrap">
                    <div class="p-2 w-full lg:w-1/2">
                        ...
                        <div class="mt-2">
                            <BaseInput id="name" v-model="editedTraining.name" class="shadow"
                                :placeholder="editedTraining.name" required />
                        </div>
                    </div>
                    <div class="p-2 w-full lg:w-1/2">
                        <div class="flex">
                            <div v-if="editedTraining.img !== null">
                ...
                <div class="p-2 w-full">
                    ...
                    <div class="mt-2">
                        <BaseTextarea id="description" v-model="editedTraining.description" class="shadow" rows="4"
                            :placeholder="editedTraining.description" required />
                    </div>
                </div>
                <div class="flex flex-wrap">
                    <div class="p-2 w-full lg:w-1/3">
                        ...
                        <div class="mt-2">
                            <BaseInput id="coach" v-model="editedTraining.coach" class="shadow"
                                :placeholder="editedTraining.coach" required />
                        </div>
                    </div>
                    <div class="p-2 w-full lg:w-1/3">
                        <BaseLabel for="price" class="text-sm">Precio: $</BaseLabel>
                        <div class="mt-2">
                            <BaseInput type="number" id="price" v-model="editedTraining.price" class="shadow"
                                :placeholder="editedTraining.price" required />
                        </div>
                    </div>
                    <div class="p-2 w-full sm:w-1/3">
                        <BaseLabel for="difficulty" class="text-sm">Dificultad: </BaseLabel>
                        <div class="mt-2">
                            <BaseInput id="difficulty" v-model="editedTraining.difficulty" class="shadow"
                                :placeholder="editedTraining.difficulty" required />
                        </div>
                    </div>
                </div>
                <div class="flex gap-4 justify-end">
                    <CancelButton @click="closeEdit">Cerrar</CancelButton>
                    <BaseButton class="rounded-full p-3 ml-2" :loading="editLoading">Editar</BaseButton>
                </div>
            </form>
        </div>
    </div>
