...
<template>
    <div class="container mx-auto p-4">
      <table class="max-w-full bg-white border border-gray-300 mx-auto">
        <thead>
          <tr>
            <th class="py-2 px-8 border-b">Imagen</th>
            <th class="py-2 px-8 border-b">Email</th>
            <th class="py-2 px-8 border-b">Entrenamientos contratados</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="item in items" :key="item.id">
            ...
            <td class="py-2 px-8 border-b">
              ...
              <template v-else>
                <p class="text-sm text-center">No tiene entrenamientos contratados.</p>
              </template>
            </td>
          </tr>
        </tbody>
