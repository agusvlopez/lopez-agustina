...
const { newMessage, messages, messagesLoading, handleSendMessage } =
    usePrivateChat(authUser, user);
    ...
    <LoadingContext :loading="userLoading">
        <section class="container p-4">
            ...
            <div class="bg-white rounded-lg shadow-md max-w-xl mx-auto m-4">
                <div>
                    <h2 class="bg-indigo-500 text-white p-3 rounded-t-lg mb-4">
                        Conversación con {{ user.email }}
                    </h2>
                </div>
                ...
                <div class="mb-6 p-4">
                    <LoadingContext :loading="messagesLoading">
                        <div class="flex mb-2" v-for="message in messages" :key="message.id" :class="{
                ...
                <form action="" @submit.prevent="handleSendMessage" class="col-8">
                    <div class="mb-2 mt-3 p-4">
                        ...
                        <div class="flex items-center mt-2">
                            <ChatInput type="text" id="message" v-model="newMessage.message" class="shadow" />
